  ...
  return (
    ...
    >
      <div className="desktop-gate-card">
        <span className="desktop-gate-eyebrow">SkinMatch</span>
        <h1 id="desktop-gate-title" className="desktop-gate-title">
          Open on your phone
        </h1>
        ...
        />
        <span className="desktop-gate-url">go-it-skin-match.vercel.app</span>
      </div>
    </div>
  );
}
